...
- Recipe: `COVER` · Role: result · Date: 2026-09-09
- [Original PNG](../assets/images/cover.png) · 1536 × 1024
...
## videoweb-cover · VideoWeb AI collection cover

- Recipe: `COVER` · Role: result · Date: 2026-09-22
- [Original PNG](../assets/images/videoweb-cover.png) · 1536 × 1024
- [Exact executed prompt](../assets/generation/videoweb-cover.txt)
- SHA-256: `447d51adcf875b6222c4a2404ab9207a1c997cad1af2683c7ff8f6631eaea968`
- Inputs: None

**Review:** All requested cover text is legible. The three miniature frames change camera distance and explorer scale; use as editorial cover art, not a continuity benchmark.

## p092-videoweb · VideoWeb P092 generated concept

- Recipe: `P092` · Role: result · Date: 2026-09-22
- [Original PNG](../assets/images/p092-videoweb.png) · 1086 × 1448
- [Exact executed prompt](../assets/generation/p092-videoweb.txt)
- SHA-256: `f5aef32b67f495aa2134e37e76b9f3ec0637aa1cb29f77c3f54d2e9a5b090ff4`
- Inputs: None

**Review:** Full body, boots, jacket details and ink/watercolor style are visible. One hand is tucked in a pocket, so this is not a full hand/anatomy reference. Title space is present but modest; add final copy in an editor.

## p093-videoweb · VideoWeb P093 generated concept

- Recipe: `P093` · Role: result · Date: 2026-09-22
- [Original PNG](../assets/images/p093-videoweb.png) · 1672 × 941
- [Exact executed prompt](../assets/generation/p093-videoweb.txt)
- SHA-256: `2944c9c3a99b67e0788ec159794fc7b38cdabcc39d290d57bfc871a6b9a1c8f0`
- Inputs: None

**Review:** Rainy window, knit sweater, wood radio and restrained retro styling are visible. The left wall includes a framed picture and shelf; it does not fully satisfy the uncluttered title-space request. Use as a mood frame or remove those objects before adding a title. Period accuracy is not independently verified.

## p094-videoweb · VideoWeb P094 generated concept

- Recipe: `P094` · Role: result · Date: 2026-09-22
- [Original PNG](../assets/images/p094-videoweb.png) · 1672 × 941
- [Exact executed prompt](../assets/generation/p094-videoweb.txt)
- SHA-256: `4680facbbaa0318476caecf4a8bed56968dcfb48bf10f377cf6aa26e93cbdf16`
- Inputs: None
