...
![VideoWeb AI GPT Image 2.5 提示词库：纸艺岛屿、灯塔、耳机与角色故事](assets/images/videoweb-banner-v2.png)
...
本库由 VideoWeb AI 基于 [Flaq AI 源库](https://github.com/flaqai/awesome-chatgpt-images-2-5-prompts)维护，保留源库 103 条配方，新增 3 条创作者配方。共 16 个场景包、145 张图片；78 条配方为中英双语，16 条为英文，另有 12 条本地语言配方。
