...
def build():
    ...
    lines=['# Visual prompt gallery', '', '[English README](../README.md) · [Prompt index](../prompts/README.md) · [Generation log](generation-log.md)', '', '[Use GPT Image 2.5 / 开始创作](https://videoweb.ai/model/gpt-image-2-5/) · [Free, no signup / 免注册体验](https://videoweb.ai/free-gpt-image-2-5/)', '',
